...
//			}
			...
			if (null != isconnect(temp[i].getUrl())){
				...
				institution = JsoupTest.InstitutionSpringer(html);
				keyword = JsoupTest.KeywordSpringer(html);
	...
	public static Article[] setUrl() throws IOException, InterruptedException{
		...
		for(int i=0;i<a.length;i++){
			if(a[i].getUrl().contains("10.1007")){
				urlList.add(a[i]);
			}
		}
	...
	public static void main(String[] args) throws Exception{
		...
		String outpath = "C:/Users/Roc/Desktop/Springer.txt";
